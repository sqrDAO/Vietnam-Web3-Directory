...
| Name | Description | Eco | X | Status | Founders |
|------|-------------|-----|---|--------|----------|
| [sqrDAO](https://sqrdao.com/) | ​​​​​​SqrDAO is a Web3 Builders-driven community created by and for crypto builders. We aim to connect and empower technical and non-technical builders alike to collaborate and explore new ideas. | EVM, Solana | [@sqrDAO](https://x.com/sqrDAO) | `Active` | [Long "Leo" Pham](https://x.com/0x_castelian) <br/> [Danny Doan](https://x.com/TuongDoan9) <br/> [Vuong Le](https://x.com/hanjaycrypto) |
