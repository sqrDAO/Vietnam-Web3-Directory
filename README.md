...
| [Krystal](https://krystal.app/) | Krystal's mission is to make Liquidity Provisioning Profitable, Accessible, and Convenient to Anyone. | Ethereum, Solana, Arbitrum, Base, BNBChain, Optimism, Polygon, Sonic, Unichain, Avalanche, Berachain | [@KrystalDeFi](https://x.com/KrystalDeFi) | `Growth` | [Jarvis Nguyen](https://x.com/jarvis__) |
